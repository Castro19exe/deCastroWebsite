...
<body>
    ...
    <?php include 'shared/slideshow.php'; ?>

    <h2 class="h2-home"> Os mais procurados: </h2>

    <section class="produtos">
        <?php
            foreach(selectMostVisitedProducts() as $dados) { ?>
                <div class="produto">
                    <img class="img1" src="../public/img/<?php echo $dados['img1_product'] ?>">
                    <img class="img2" src="../public/img/<?php echo $dados['img2_product'] ?>">
                    ...
                    <form action="../controller/home/add-card-controller.php" method="POST">
                        ...
                        <input type="hidden" name="type" value="<?php echo $dados['fk_type_product'] ?>">
                        <?php
                        ...
                        ?>
                        <button class="btn-add-purchase" type="submit"> Adicionar ao Carrinho </button>
                    </form>
                </div>
        <?php
            }
